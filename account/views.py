...
# function for company recommendation
    ...
    def post(self, request):
        ...
        if serializer.is_valid():
            ...
            if is_individual == 'True':
                ...
                profile = Profile.objects.get(user_pk=user_db.pk)
...
class CompanyRecommendationAPIView(APIView):
    ...
    def get(self, request):
        ...
        for user in recommend_users:
            ...
            user_experience = Experience.objects.filter(user_pk=user.user_pk)
            if len(user_experience) != 0:
                temp = {"user_id": user.pk,
                        ...
                        "experience": user_experience[0].detail}
